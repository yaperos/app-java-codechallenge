...
public class KafkaConfig {
  ...
  @Bean
  public ConsumerFactory<String, TransactionInModel> antifraudConsumerConfigs() {
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, TransactionInModel> antifraudKafkaListenerContainerFactory() {
    ConcurrentKafkaListenerContainerFactory<String, TransactionInModel>
            factory = new ConcurrentKafkaListenerContainerFactory<>();
    factory.setConsumerFactory(antifraudConsumerConfigs());
    return factory;
  }
